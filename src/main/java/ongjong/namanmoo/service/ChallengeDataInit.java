...
public class ChallengeDataInit {
    ...
    public void createChallenges() {
        ...
        challenges.add(createChallenge(2, "오늘 가장 즐거웠던 순간은?", ChallengeType.NORMAL));
        challenges.add(createChallenge(3, "내가 좋아하는 음식과 싫어하는 음식은?", ChallengeType.NORMAL));
        challenges.add(createChallenge(4, "시간 여행을 한다면 언제로 가고 싶나요?", ChallengeType.NORMAL));
        challenges.add(createChallenge(5, "함께 먹고 싶은 음식 사진을 올려보세요.", ChallengeType.PHOTO));
        challenges.add(createChallenge(6, "가장 좋아하는 노래가 무엇인가요?", ChallengeType.NORMAL));
        challenges.add(createChallenge(7, "가족 중 한 명이 갑자기 바퀴벌레가 된다면 당신의 반응은?", ChallengeType.NORMAL));
        challenges.add(createChallenge(8, "가족과 여행을 간다면 어디로 가고 싶나요?", ChallengeType.NORMAL));
        challenges.add(createChallenge(9, "배우자와의 첫 만남은 어디에서 또는 어떻게 이루어졌나요?", ChallengeType.GROUP_PARENT));
        ...
        challenges.add(createChallenge(23, "부모님이 멋있었던 순간은?", ChallengeType.GROUP_CHILD));
        challenges.add(createChallenge(24, "가장 기억에 남는 가족 여행지와 그 이유는 무엇입니까?", ChallengeType.NORMAL));
        challenges.add(createChallenge(25, "가장 좋아하는 계절과 이유는는 무엇인가요?", ChallengeType.NORMAL));
        challenges.add(createChallenge(26, "학생 때 졸업 사진을 올려주세요", ChallengeType.PHOTO));
        challenges.add(createChallenge(27, "가족 중 요리 잘하는 사람과 그 요리는 무엇인가요?", ChallengeType.NORMAL));
        challenges.add(createChallenge(28, "가족에게 고마운 점이 있다면 무엇입니까?", ChallengeType.NORMAL));
        challenges.add(createChallenge(29, "가족에게 사과하지 못한 일이 있다면?", ChallengeType.NORMAL));
        ...
        challenges.add(createChallenge(32, "오늘 가장 즐거웠던 순간은?", ChallengeType.NORMAL));
        challenges.add(createChallenge(33, "내가 좋아하는 음식과 싫어하는 음식은?", ChallengeType.NORMAL));
        challenges.add(createChallenge(34, "시간 여행을 한다면 언제로 가고 싶나요?", ChallengeType.NORMAL));
        challenges.add(createChallenge(35, "함께 먹고 싶은 음식 사진을 올려보세요.", ChallengeType.PHOTO));
        challenges.add(createChallenge(36, "가장 좋아하는 노래가 무엇인가요?", ChallengeType.NORMAL));
        challenges.add(createChallenge(37, "가족 중 한 명이 갑자기 바퀴벌레가 된다면 당신의 반응은?", ChallengeType.NORMAL));
        challenges.add(createChallenge(38, "가족과 여행을 간다면 어디로 가고 싶나요?", ChallengeType.NORMAL));
        challenges.add(createChallenge(39, "배우자와의 첫 만남은 어디에서 또는 어떻게 이루어졌나요?", ChallengeType.GROUP_PARENT));
        ...
        challenges.add(createChallenge(53, "부모님이 멋있었던 순간은?", ChallengeType.GROUP_CHILD));
        challenges.add(createChallenge(54, "가장 기억에 남는 가족 여행지와 그 이유는 무엇입니까?", ChallengeType.NORMAL));
        challenges.add(createChallenge(55, "가장 좋아하는 계절과 이유는는 무엇인가요?", ChallengeType.NORMAL));
        challenges.add(createChallenge(56, "학생 때 졸업 사진을 올려주세요", ChallengeType.PHOTO));
        challenges.add(createChallenge(57, "가족 중 요리 잘하는 사람과 그 요리는 무엇인가요?", ChallengeType.NORMAL));
        challenges.add(createChallenge(58, "가족에게 고마운 점이 있다면 무엇입니까?", ChallengeType.NORMAL));
        challenges.add(createChallenge(59, "가족에게 사과하지 못한 일이 있다면?", ChallengeType.NORMAL));
        ...
        challenges.add(createChallenge(62, "오늘 가장 즐거웠던 순간은?", ChallengeType.NORMAL));
        challenges.add(createChallenge(63, "내가 좋아하는 음식과 싫어하는 음식은?", ChallengeType.NORMAL));
        challenges.add(createChallenge(64, "시간 여행을 한다면 언제로 가고 싶나요?", ChallengeType.NORMAL));
        challenges.add(createChallenge(65, "함께 먹고 싶은 음식 사진을 올려보세요.", ChallengeType.PHOTO));
        challenges.add(createChallenge(66, "가장 좋아하는 노래가 무엇인가요?", ChallengeType.NORMAL));
        challenges.add(createChallenge(67, "가족 중 한 명이 갑자기 바퀴벌레가 된다면 당신의 반응은?", ChallengeType.NORMAL));
        challenges.add(createChallenge(68, "가족과 여행을 간다면 어디로 가고 싶나요?", ChallengeType.NORMAL));
        challenges.add(createChallenge(69, "배우자와의 첫 만남은 어디에서 또는 어떻게 이루어졌나요?", ChallengeType.GROUP_PARENT));
        ...
        challenges.add(createChallenge(83, "부모님이 멋있었던 순간은?", ChallengeType.GROUP_CHILD));
        challenges.add(createChallenge(84, "가장 기억에 남는 가족 여행지와 그 이유는 무엇입니까?", ChallengeType.NORMAL));
        challenges.add(createChallenge(85, "가장 좋아하는 계절과 이유는는 무엇인가요?", ChallengeType.NORMAL));
        challenges.add(createChallenge(86, "학생 때 졸업 사진을 올려주세요", ChallengeType.PHOTO));
        challenges.add(createChallenge(87, "가족 중 요리 잘하는 사람과 그 요리는 무엇인가요?", ChallengeType.NORMAL));
        challenges.add(createChallenge(88, "가족에게 고마운 점이 있다면 무엇입니까?", ChallengeType.NORMAL));
        challenges.add(createChallenge(89, "가족에게 사과하지 못한 일이 있다면?", ChallengeType.NORMAL));
        ...
        challenges.add(createChallenge(92, "오늘 가장 즐거웠던 순간은?", ChallengeType.NORMAL));
        challenges.add(createChallenge(93, "내가 좋아하는 음식과 싫어하는 음식은?", ChallengeType.NORMAL));
        challenges.add(createChallenge(94, "시간 여행을 한다면 언제로 가고 싶나요?", ChallengeType.NORMAL));
        challenges.add(createChallenge(95, "함께 먹고 싶은 음식 사진을 올려보세요.", ChallengeType.PHOTO));
        challenges.add(createChallenge(96, "가장 좋아하는 노래가 무엇인가요?", ChallengeType.NORMAL));
        challenges.add(createChallenge(97, "가족 중 한 명이 갑자기 바퀴벌레가 된다면 당신의 반응은?", ChallengeType.NORMAL));
        challenges.add(createChallenge(98, "가족과 여행을 간다면 어디로 가고 싶나요?", ChallengeType.NORMAL));
        challenges.add(createChallenge(99, "배우자와의 첫 만남은 어디에서 또는 어떻게 이루어졌나요?", ChallengeType.GROUP_PARENT));
        ...
        challenges.add(createChallenge(113, "부모님이 멋있었던 순간은?", ChallengeType.GROUP_CHILD));
        challenges.add(createChallenge(114, "가장 기억에 남는 가족 여행지와 그 이유는 무엇입니까?", ChallengeType.NORMAL));
        challenges.add(createChallenge(115, "가장 좋아하는 계절과 이유는는 무엇인가요?", ChallengeType.NORMAL));
        challenges.add(createChallenge(116, "학생 때 졸업 사진을 올려주세요", ChallengeType.PHOTO));
        challenges.add(createChallenge(117, "가족 중 요리 잘하는 사람과 그 요리는 무엇인가요?", ChallengeType.NORMAL));
        challenges.add(createChallenge(118, "가족에게 고마운 점이 있다면 무엇입니까?", ChallengeType.NORMAL));
        challenges.add(createChallenge(119, "가족에게 사과하지 못한 일이 있다면?", ChallengeType.NORMAL));
